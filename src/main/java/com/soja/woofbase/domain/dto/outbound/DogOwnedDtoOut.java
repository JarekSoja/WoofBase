...
public class DogOwnedDtoOut extends DogDtoOut {
    ...
    public DogOwnedDtoOut(User user, String dogName, String dogColour, boolean dogSex, LocalDate dateOfBirth, LocalDate dateOfDeath,
